...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task2()
        {
            ...
            var methodSyntax =
                Emps
                    .Where(e => e.Job.Equals("Frontend programmer") && e.Salary > 100)
        ...
        public static IEnumerable<object> Task7()
        {
            var methodSyntax = Emps
                .GroupBy(e => e.Job)
                .Select(em => new { Praca = em.Key, LiczbaPracownikow = em.Count()});
        ...
        public static IEnumerable<object> Task11()
        {
            ...
            IEnumerable<object> result = dividedEmps;
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.EmpsWithSubordiates(Emps);
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            result = Depts
                ...
                .SelectMany(
                    ...
                    (x, y) => new { x.Dept, Count = y != null ? y.Count : 0 })
    ...
    {
        public static IEnumerable<Emp> EmpsWithSubordiates(this IEnumerable<Emp> emps)
        {
            var managers = new HashSet<int>(emps.Where(e => e.Mgr != null).Select(e => e.Mgr.Empno));

            return emps
                .Where(emp => managers.Contains(emp.Empno))
